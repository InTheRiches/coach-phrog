    ...
    const content = (
        <div className="w-full max-w-5xl flex-col">
            ...
            <div className="flex flex-col mb-12">
                <span className="text-cyan-accent mb-1 text-lg">Getting Started</span>

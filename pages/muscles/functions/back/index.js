...
export default function MuscleFunctions({}) {
    return (
        <div className="flex flex-col min-h-screen bg-cyan-400 dark:bg-neutral-900 text-slate-50 justify-center items-center">
            ...
            <div className="grid gap-8 grid-cols-270px max-w-screen-4xl md:px-6 my-8 mr-56">
                ...
                <div className="flex-1 w-full max-w-5xl flex-col">
                    ...
                    <div className="flex flex-col mb-12">
                        ...
                        <div className={"ml-6 border-cyan-400 border-1 flex flex-col p-4 bg-neutral-500 bg-opacity-5 rounded-md"}>

...
export default function PerformanceBCAAs({}) {
    ...
    return (
        <ContentPage currentTopic={"Supplements-Performance-BCAAs"} content={content}></ContentPage>
    )
}
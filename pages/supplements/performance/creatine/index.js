    ...
    const content = (
        <div className="flex-1 w-full max-w-5xl flex-col">
            ...
            <Content
                ...
                content="Creatine is produced from amino acids, primarily in the liver, but also in smaller quantities in the kidneys and pancreas. It functions as a reservoir for high-energy phosphate groups in the form of phosphocreatine, which can be contributed to ADP reforming into ATP, the primary energy carrier in the body. This function is especially significant in circumstances of elevated energy demands, such as during intense physical or mental exertion. Creatine is abundant in animal-based meals, with meat and fish being the most common sources. It is most commonly supplemented in powder form."
            ></Content>
            <Content
                id={"when-how"}
